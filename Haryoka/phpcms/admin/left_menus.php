<div class="col-md-3">
	<div class="list-group">
		...
		Dashboard <span class="badge"><?php echo $post->totalPost()+$user->totalUser(); ?></span>
		<span class="badge" style="visibility:hidden"><?php echo $post->totalPost()+$category->totalCategory()+$user->totalUser(); ?></span>
		</a>		
